...
class CategoriesSeeder extends Seeder
{
    ...
    public function run()
    {
        $categories = [
            ...
            ['name' => 'Food', 'backgroundColor' => '#e74c3c', 'textColor' => '#ffffff'],
            ['name' => 'Fashion', 'backgroundColor' => '#9b59b6', 'textColor' => '#ffffff'],
            ['name' => 'Health & Fitness', 'backgroundColor' => '#27ae60', 'textColor' => '#ffffff'],
            ...
            ['name' => 'Business & Finance', 'backgroundColor' => '#34495e', 'textColor' => '#ffffff'],
            ...
            ['name' => 'Art & Design', 'backgroundColor' => '#8e44ad', 'textColor' => '#ffffff'],
